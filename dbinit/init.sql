...
INSERT INTO game (abreviatura, fecha_de_lanzamiento, nombre_completo, descripcion) VALUES
    ...
    ('ykw2', '2013-7-10', 'Yo-Kai Watch 2', 'El juego trata sobre las aventuras de Nathan Adams, un niño de 11 años al que le roban el reloj Yo-kai, junto a Whisper y Jibanyan, tendrán que adentrarse en el pasado para derrotar a Lady Desdicha, villana principal, y sus secuaces, los Yo-kai maléficos.');
